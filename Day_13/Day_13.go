...
import (
	...
	"golang-study/huqi/Day_13/route"
	"io/ioutil"
	"os"
)
...
func init() {
	//读取RSA公钥和私钥
	resPrivateKey, err2_1 = ioutil.ReadFile("huqi/Day_13/private.pem")
	resPublicKey, err2_2 = ioutil.ReadFile("huqi/Day_13/public.pem")
	...
	//生成椭圆曲线秘钥对
	eccPrivateKay, eccPublicKey, err3 = getEcdsaKey(2)
	if err3 != nil {
		panic(err3)
		return
	}
